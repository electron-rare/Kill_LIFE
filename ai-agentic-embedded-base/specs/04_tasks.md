...
- [x] T-LC-003 - Revalidate the strict spec contract after each auto-fix run.
  - Evidence: `python3 tools/validate_specs.py --strict --require-mirror-sync`
- [x] T-LC-004 - Re-run the stable Python suite after the chained lots.
  - Evidence: `bash tools/test_python.sh --suite stable`
- [ ] T-LC-005 - Choose the next manual lot once automation reaches a real fork.
