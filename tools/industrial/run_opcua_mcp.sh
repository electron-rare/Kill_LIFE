...
SERVER_SCRIPT="$ROOT_DIR/tools/industrial/opcua_mcp.py"
source "$ROOT_DIR/tools/lib/runtime_home.sh"
kill_life_runtime_home_init "$ROOT_DIR" "opcua-mcp"
MASCARADE_DIR="$(
