...
| `collect_evidence` | `0` | `tools/collect_evidence.py esp` | Evidence pack généré pour esp: /Users/electron/Kill_LIFE/docs/evidence/esp |
...
| `collect_evidence` | `0` | `tools/collect_evidence.py linux` | Evidence pack généré pour linux: /Users/electron/Kill_LIFE/docs/evidence/linux |
